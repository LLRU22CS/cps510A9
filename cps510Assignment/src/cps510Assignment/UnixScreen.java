...
public class UnixScreen extends Screen {
    ...
    public Scene getScene() {
        ...
        exitButton.setOnAction(e -> this.switchScene("AdminLoginScreen.java"));
        dropTablesButton.setOnAction(e -> dropTables());
        createTablesButton.setOnAction(e -> createTables());
        populateTablesButton.setOnAction(e -> populateTables());
        queryTablesButton.setOnAction(e -> queryTables());
